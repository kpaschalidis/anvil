...
"""Deep research workflow implementation.

Split from `anvil.workflows.deep_research` to keep modules smaller and more maintainable.
...
from anvil.workflows.deep_research_prompts import (
    ...
    _outline_prompt,
    _planning_prompt,
    _section_findings_prompt,
    _summary_prompt,
    _synthesis_prompt,
    _verification_prompt,
    _verification_prompt_from_memo,
)
from anvil.workflows.deep_research_synthesis_utils import _compact_findings_for_outline, _select_diverse_findings
...
class DeepResearchWorkflow(DeepResearchPlanningMixin, DeepResearchWorkersMixin, DeepResearchRenderMixin):
    def __init__(
        self,
        *,
